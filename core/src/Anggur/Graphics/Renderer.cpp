...
namespace Anggur 
{
    ...
    void Renderer::RenderTexturedRectangle(const Matrix4& model, const Vector3& point0, const Vector3& point1, const std::shared_ptr<Texture2D>& texture, const Vector2& texturePoint0, const Vector2& texturePoint1, const Vector4& color)
    {
        Render(
            {
                // position                                           // normal                  // color                                     // texCoord         
    ...
    void Renderer::RenderCircle(const Matrix4& model, float radius, int segment, const Vector4& color)
    {
        if (segment < 3)
            segment = 3;
    ...
    void Renderer::RenderArc(const Matrix4& model, float radius, float beginAngle, float sweepAngle, int segment, const Vector4& color)
    {
        if (segment < 3)
            segment = 3;
